...
// =====================================================
// ENQUIRY FORM
// This form is intentionally frontend-only. It updates local
// component state and shows a success message, but does not
// send data to a backend, database, or email service.
// =====================================================
  ...
  if (submitted) {
    return (
      <div className="enquiry-success">
        ...
        <p>
          This prototype does not submit to a database yet. Unity can connect this form in the
          next stage.
        </p>
  ...
  return (
    <form className="enquiry-form" onSubmit={handleSubmit}>
      <div className="form-heading">
        <p className="eyebrow">
          <span /> Request this service
        </p>
        <button type="button" aria-label="Close request form" onClick={onClose}>
          ×
        </button>
      </div>
...
// =====================================================
// SERVICE DETAIL PAGE
// Receives a service object from the shared service dataset and
// renders a reusable detail layout for each item.
// =====================================================
  ...
  return (
    <main className="detail-page" id="top">
      <section className="detail-hero">
        ...
        <p className="detail-lede">{service.fullDescription || CONTENT_PENDING}</p>
      ...
      <section className="detail-grid">
        <article className="detail-content">
          ...
          <p className="detail-placeholder">
            {service.status === 'placeholder' ? CONTENT_PENDING : service.fullDescription}
          </p>
        </article>
        ...
        <aside className="detail-facts">
          <div>
            <span>STATUS</span>
            <p>{service.placeholder ? 'Placeholder content' : service.status}</p>
          </div>
          ...
          <div>
            ...
            <p>{service.processingInformation}</p>
          </div>
      ...
      {formOpen && (
        ...
        >
          <EnquiryForm service={service} onClose={() => setFormOpen(false)} />
        </div>
      )}
    </main>
  )
